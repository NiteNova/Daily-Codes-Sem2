...
def sheepMove(position):
    ...
    elif position[2] == RIGHT and position[0] < 740:
...
sheep2 = [400, 400, DOWN, False]
sheep3 = [600, 600, UP, False]
sheep4 = [400, 550, LEFT, False]
sheep5 = [100, 200, DOWN, False]
sheep6 = [100, 500, DOWN, False]
